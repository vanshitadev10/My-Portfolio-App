    ...
    return (
        <div className={styles.section} id='experience' style={{ color: !modeCtx.mode ? '#000' : '#fff' }}>
            ...
            <div className={styles.list}>
                <WorkCard src={mastork} alt={'Mastork Technologies'} heading={'Mastork Technologies'} duration={'October 2022 - Present'} position={'Front-End Developer'} detail={'Responsible for creating clean and well-tested react components according to specifications, working with the design team to reproduce the design and interacting with the back-end team to integrate the front-end with the Node.js back-end.'} button link1={'https://spotlet-ab4fa.web.app/'} btn1='Website' />
