...
const Proficiency = () => {
    ...
    return (
        <div className={styles.proficiency} data-aos='fade-right' data-aos-duration='700' data-aos-easing='ease-in-out' data-aos-delay='200' data-aos-once='true' style={{ color: !modeCtx.mode ? '#000' : '#fff' }}>
